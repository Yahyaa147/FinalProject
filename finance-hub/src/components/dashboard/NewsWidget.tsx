    ...
    <div className={`bg-white rounded-2xl shadow-sm border border-gray-200/50 overflow-hidden ${className}`}>
      <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 border-b border-gray-200/50">
        ...
        <div className="mt-4 grid grid-cols-3 gap-2">
          ...
          <div className="text-center">
            <div className="text-lg font-bold text-gray-600">{sentiment.neutral}</div>
            ...
            <div key={article.id} className="border-b border-gray-100 pb-4 last:border-b-0 last:pb-0">
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-gray-900 mb-2 leading-snug hover:text-purple-600 transition-colors">
                    <Link 
